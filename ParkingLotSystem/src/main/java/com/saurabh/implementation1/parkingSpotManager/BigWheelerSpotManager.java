...
public class BigWheelerSpotManager implements ParkingSpotManager {
    ...
    public BigWheelerSpotManager(List<ParkingSpot> parkingSpotList, ParkingSpotLookUpStrategy parkingSpotLookUpStrategy) {
