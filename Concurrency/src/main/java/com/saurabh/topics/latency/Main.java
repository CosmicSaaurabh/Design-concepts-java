 ...
 */
public class Main {
    public static final String SOURCE_FILE = "image.jpg";
    public static final String DESTINATION_FILE = "output.jpg";
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (is == null) {
            throw new IllegalArgumentException("Image not found on classpath: " + SOURCE_FILE);
        }
